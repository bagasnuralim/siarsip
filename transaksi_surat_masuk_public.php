        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 3){
            ...
            if(isset($_REQUEST['act'])){
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsmp" class="judul"><i class="material-icons">mail</i> Surat Masuk Public</a></li>
                                    ...
                                    <div class="col m5 hide-on-med-and-down">
                                        <form method="post" action="?page=tsmp">
                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <div class="col s12" style="margin-top: -18px;">
                            <div class="card blue lighten-5">
                                ...
                                <p class="description">Hasil pencarian untuk kata kunci <strong>"'.stripslashes($cari).'"</strong><span class="right"><a href="?page=tsmp"><i class="material-icons md-36" style="color: #333;">clear</i></a></span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    ...
                                    <th width="14%">Status Publish</th>
                                    <th width="20%">Asal Surat<br/>Referensi Surat</th>
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE status_publish = '0' AND isi LIKE '%$cari%' ORDER by id_surat DESC LIMIT 15");
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                  ...
                                  <tr>
                                    ...
                                    <td>'.$row['asal_surat'].'<br/><hr/><a href="?page=gsk&act=rsk&no_surat='.$row['referensi_surat'].'">'.$row['referensi_surat'].'</a>'.'</td>
                    ...
                    <!-- Row form END -->';
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk where status_publish ='0' ORDER by id_surat DESC LIMIT $curr, $limit");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                    ...
                    $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk where status_publish ='0'");
                    ...
                    if($cdata > $limit ){
                        ...
                        if($pg > 1){
                            $prev = $pg - 1;
                            echo '<li><a href="?page=tsmp&pg=1"><i class="material-icons md-48">first_page</i></a></li>
                                  <li><a href="?page=tsmp&pg='.$prev.'"><i class="material-icons md-48">chevron_left</i></a></li>';
                        } else {
                        ...
                        for ($i = 1; $i <= $cpg; $i++) {
                            if ((($i >= $pg - 3) && ($i <= $pg + 3)) || ($i == 1) || ($i == $cpg)) {
                                if ($i == $pg) echo '<li class="active waves-effect waves-dark"><a href="?page=tsmp&pg='.$i.'"> '.$i.' </a></li>';
                                else echo '<li class="waves-effect waves-dark"><a href="?page=tsmp&pg='.$i.'"> '.$i.' </a></li>';
                            }
                        }
                        ...
                        if($pg < $cpg){
                            $next = $pg + 1;
                            echo '<li><a href="?page=tsmp&pg='.$next.'"><i class="material-icons md-48">chevron_right</i></a></li>
                                  <li><a href="?page=tsmp&pg='.$cpg.'"><i class="material-icons md-48">last_page</i></a></li>';
                        } else {
