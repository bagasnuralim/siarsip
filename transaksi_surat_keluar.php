                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar WHERE isi LIKE '%$cari%' AND	(`status_publish` = '0' OR `status_publish` = '1' AND `nip` ='$nip_user') ORDER by id_surat DESC LIMIT $curr, 15");
