            ...
            $pg = @$_GET['pg'];
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tskp" class="judul"><i class="material-icons">drafts</i> Surat Keluar Public</a></li>
                                    ...
                                    <div class="col m5 hide-on-med-and-down">
                                        <form method="post" action="?page=tskp">
                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <div class="col s12" style="margin-top: -18px;">
                            <div class="card blue lighten-5">
                                ...
                                <p class="description">Hasil pencarian untuk kata kunci <strong>"'.stripslashes($cari).'"</strong><span class="right"><a href="?page=tskp"><i class="material-icons md-36" style="color: #333;">clear</i></a></span></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        ...
                                        <th width="15%">Status Publish</th>
                                        <th width="20%">Tujuan<br/>Referensi Surat</th>
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar WHERE status_publish = '0' AND isi LIKE '%$cari%' ORDER by id_surat DESC LIMIT $curr, 15");
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            //script untuk mencari data
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar WHERE status_publish = '0' ORDER by id_surat DESC LIMIT $curr, $limit");
                            if(mysqli_num_rows($query) > 0){
                                $no = 1;
                                while($row = mysqli_fetch_array($query)){
                                  echo '
                                  <tr>
                                    ...
                                    <td>'.$row['tujuan'].'<br/><hr/>'.'<a href="?page=gsm&act=rsm&no_surat='.$row['referensi_surat'].'">'.$row['referensi_surat'].'</a></td>
                    ...
                    if($cdata > $limit ){
                        ...
                        if($pg > 1){
                            $prev = $pg - 1;
                            echo '<li><a href="?page=tskp&pg=1"><i class="material-icons md-48">first_page</i></a></li>
                                  <li><a href="?page=tskp&pg='.$prev.'"><i class="material-icons md-48">chevron_left</i></a></li>';
                        } else {
                        ...
                        for ($i = 1; $i <= $cpg; $i++) {
                            if ((($i >= $pg - 3) && ($i <= $pg + 3)) || ($i == 1) || ($i == $cpg)) {
                                if ($i == $pg) echo '<li class="active waves-effect waves-dark"><a href="?page=tskp&pg='.$i.'"> '.$i.' </a></li>';
                                else echo '<li class="waves-effect waves-dark"><a href="?page=tskp&pg='.$i.'"> '.$i.' </a></li>';
                            }
                        }
                        ...
                        if($pg < $cpg){
                            $next = $pg + 1;
                            echo '<li><a href="?page=tskp&pg='.$next.'"><i class="material-icons md-48">chevron_right</i></a></li>
                                  <li><a href="?page=tskp&pg='.$cpg.'"><i class="material-icons md-48">last_page</i></a></li>';
                        } else {
