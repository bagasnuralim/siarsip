    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['no_agenda'] == "" || $_REQUEST['no_surat'] == "" 
                || $_REQUEST['tujuan'] == "" || $_REQUEST['isi'] == "" 
                || $_REQUEST['referensi_suratk'] == "" || $_REQUEST['status_publishk'] == "" 
                ...
                if(!preg_match("/^[0-9]*$/", $no_agenda)){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $no_surat)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $tujuan)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $referensi_surat)){
                                $_SESSION['referensi_suratk'] = 'Form Isi Ringkas hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), kurung(), underscore(_), dan(&) persen(%) dan at(@)';
                                echo '<script language="javascript">window.history.back();</script>';
                            } else {
                            if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $status_publish)){
                ...
                <form class="col s12" method="POST" action="?page=tsk&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="referensi_suratk" type="text" class="validate" name="referensi_suratk" required>
                                <?php
