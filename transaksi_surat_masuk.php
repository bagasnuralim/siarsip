                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE isi LIKE '%$cari%' AND	(`status_publish` = '0' OR `status_publish` = '1' AND `nip` ='$nip_user') ORDER by id_surat DESC LIMIT 15");
                    ...
                    <!-- Row form END -->';
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE `status_publish` = '0' OR `status_publish` = '1' AND `nip` ='$nip_user' ORDER by id_surat DESC LIMIT $curr, $limit");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
